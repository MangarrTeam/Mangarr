...
MANGARR_DIR = Path(__file__).resolve().parent.parent.parent
BASE_DIR = MANGARR_DIR.parent
...
LOCALE_PATH = Path(os.path.join(MANGARR_DIR, 'locale'))
...
MANGA_ROOT = Path(os.path.join(BASE_DIR, 'manga'))
