...
urlpatterns = [
    ...
    path('manager/users/<int:user_id>/nsfw/', views.toggle_nsfw_user, name='toggle_user_nsfw'),
    path('manager/users/<int:user_id>/permissions/', views.get_user_permissions, name='get_user_permissions'),
    path('manager/users/<int:user_id>/libraries/', views.get_user_libraries, name='get_user_libraries'),
    path('manager/users/<int:user_id>/permissions/update/', views.update_user_permissions, name='update_user_permissions'),
    path('manager/users/<int:user_id>/libraries/update/', views.update_user_libraries, name='update_user_libraries'),
